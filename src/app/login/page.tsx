  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="bg-white border border-gray-200 rounded-lg p-8 w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to CollegeFind</h1>
        <p className="text-gray-500 mb-6">Sign in to save colleges and comparisons.</p>
        ...
        <Link href="/" className="text-sm text-indigo-600 hover:underline mt-4 inline-block">
          ← Back to Home
        </Link>
      </div>
    </div>
